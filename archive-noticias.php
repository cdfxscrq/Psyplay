...
<li><a href="<?php bloginfo('url'); ?>/notice"><?php _e('Announcements', 'psythemes'); ?></a></li>
</ul>
...
$imgsrc = get_template_directory_uri() . '/assets/css/img/news_big_noimg.png';
} 
?>
...
<?php $noners = noticias_get_meta("views"); if(function_exists('the_views') && !empty($noners)) { ?><span class="ml10"><i class="fa fa-eye mr5"></i><?php echo $noners; ?></span><?php }?>
</p>
</div>
<div class="clearfix"></div>
</div>
