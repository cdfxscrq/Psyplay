...
$img = get_template_directory_uri().'/assets/css/img/news_nocover.png';
$imgsrc = $img;
}
 ?>
...
<?php $active = get_option('article-related'); if ($active == "enable") : get_template_part('includes/parts/widgets/nws_sidebar'); endif;?>
