...
<?php include_once 'parts/video-lock.php'; ?>
</div>
...
<?php $noners = episodios_get_meta("views"); if(function_exists('the_views') && !empty($noners)) { ?><p><strong><?php _e('Views:', 'psythemes'); ?></strong> <?php echo $noners;?></p><?php }?>
<?php }?>
...
<?php if(get_option('dltb_ep') != "false") : get_template_part('includes/single/parts/link-lock'); endif;?>
...
<!--related-->
<?php get_template_part('includes/single/parts/related_tv'); ?>
<!--/related-->
<?php }?>
