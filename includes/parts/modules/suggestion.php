...
<?php }?>
<?php if(function_exists('the_views')) { $active = get_option('sugg_mviews'); if ($active == "true") { ?>
...
<?php }?>
<?php if(function_exists('the_ratings')) { $active = get_option('sugg_trating'); if ($active == "true") { ?>
...
<?php include_once 'suggestion/featured.php'; ?>	
<?php if(function_exists('the_views')) {  $active = get_option('sugg_mviews'); if ($active == "true") { ?>
<div id="topview-today" class="movies-list movies-list-full tab-pane in fade">
<div id="content-box">
<?php include_once 'suggestion/most_viewed.php'; ?>	
</div>
<div class="clearfix"></div>
</div>
<?php } }?>
...
<div id="content-box">
<?php include_once 'suggestion/most_favorite.php'; ?>
</div>
<div class="clearfix"></div>
</div>
<?php }?>
...
<div id="content-box">
<?php include_once 'suggestion/top_rating.php'; ?>
</div>
<div class="clearfix"></div>
</div>
<?php } }?>
...
<div id="content-box">
<?php include_once 'suggestion/top_imdb.php'; ?>
</div>
<div class="clearfix"></div>
</div>
<?php }?>
