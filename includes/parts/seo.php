...
<meta property="og:image" content="<?php if($active = get_option('fbcapture-image') ) { echo $active;  } else {?><?php echo get_template_directory_uri(); ?>/images/fb-capture.png<?php }?>"/>
