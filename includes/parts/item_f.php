<?php 
$movie_preview = get_option('xtras_imglazy');
$cond[0]  = ($movie_preview == "true") ? 'data-original="'.psy_get_thumb().'"class="lazy thumb mli-thumb"' : 'src="'.psy_get_thumb().'" class="mli-thumb"';
?>
...
<span class="mli-quality"><?php echo $mostrar; ?></span>
<?php } elseif($dato = episodios_get_meta('episode_number')) { ?>
