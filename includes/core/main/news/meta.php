...
if ( ! function_exists( 'noticias_get_meta' ) ) {
...
if ( ! function_exists( 'noticias_add_meta_box' ) ) {
...
add_action( 'add_meta_boxes', 'noticias_add_meta_box' );
}


if ( ! function_exists( 'noticias_html' ) ) {
function noticias_html( $post) { wp_nonce_field( '_noticias_nonce', 'noticias_nonce' ); ?>
...
if ( ! function_exists( 'noticias_save' ) ) {
...
if ( ! function_exists( 'custom_admin_js4' ) ) {
