<?php
if ( ! function_exists( 'enqueue_date_picker' ) ) {
function enqueue_date_picker(){
    wp_enqueue_script(
        'field-date', 
        get_template_directory_uri() . '/includes/core/framework/js/field-date.js', 
...
if ( ! function_exists( 'sched_get_meta' ) ) {
...
if ( ! function_exists( 'sched_add_meta_box' ) ) {
...
add_action( 'add_meta_boxes', 'sched_add_meta_box' ); 
}

if ( ! function_exists( 'sched_html' ) ) {
function sched_html( $post) { wp_nonce_field( '_sched_nonce', 'sched_nonce' ); ?>
...
if ( ! function_exists( 'series_get_meta' ) ) {
...
if ( ! function_exists( 'series_add_meta_box' ) ) {
...
add_action( 'add_meta_boxes', 'series_add_meta_box' ); } 

if ( ! function_exists( 'series_html' ) ) {
function series_html( $post) { wp_nonce_field( '_series_nonce', 'series_nonce' ); ?>
...
<tr id="last_air_date_box">
			...
			<td class="field">
				<input class="small-text" type="date" name="last_air_date" id="last_air_date" value="<?php echo series_get_meta( 'last_air_date' ); ?>">
			</td>
		</tr>
...
<?php  } }
if ( ! function_exists( 'series_save' ) ) {
...
if ( ! function_exists( 'custom_admin_js2' ) ) {
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/includes/core/framework/js/idtabstbb.js"></script>
<?php get_template_part('includes/core/script'); ?>
<?php 
  } }
