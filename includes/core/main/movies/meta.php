...
if ( ! function_exists( 'info_movie_get_meta' ) ) {
...
if ( ! function_exists( 'info_movie_add_meta_box' ) ) {
...
if ( ! function_exists( 'info_movie_html' ) ) {
...
if ( ! function_exists( 'info_movie_save' ) ) {
...
if ( ! function_exists( 'custom_admin_js' ) ) {
...
if ( ! function_exists( 'mostrar_trailer_meta' ) ) {
