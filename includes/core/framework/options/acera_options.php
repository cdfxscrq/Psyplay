...
array(
    ...
    "type" => "tips",
    "text" => __("Only fill up these forms if you selected smtp as delivery method on report or request settings. Otherwise it's unecessary.", "psythemes"),
),	
...
array(
    ...
    "options" => array("ssl" => __('SSL','psythemes'), "tls" => __('TLS','psythemes')), //Required
    "default" => "ssl"
),
...
array(
    ...
    "under_section" => "smtp-config", //Required
    "type" => "text", //Required
    "name" => __( "Server", "psythemes" ), //Required
	"id" => "rprt-smtp-servr",
    "display_checkbox_id" => "toggle_checkbox_id",
...
array(
    ...
    "under_section" => "smtp-config", //Required
    "type" => "text", //Required
    "name" => __( "Username", "psythemes" ), //Required
	"id" => "rprt-smtp-usern",
    "display_checkbox_id" => "toggle_checkbox_id",
...
array(
    ...
    "under_section" => "smtp-config", //Required
    "type" => "text", //Required
    "name" => __( "Password", "psythemes" ), //Required
	"id" => "rprt-smtp-passw",
    "display_checkbox_id" => "toggle_checkbox_id",
...
array(
    ...
    "name" => __( "Port", "psythemes" ), //Required
	"id" => "rprt-smtp-port",
	"default" => "465",
	"placeholder" => "465"
),
...
array(
    ...
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array("disabled" => __('Disable','psythemes'), "wp_comment" => __('Wordpress','psythemes'), "fb_comment" => __('Facebook Comments','psythemes'),"dq_comment" => __('Disqus Comments','psythemes')), //Required
...
array(
    ...
    "under_section" => "rqst-config", //Required
    "type" => "text", //Required
    "name" => __( "Email Reciever", "psythemes" ), //Required
...
array(
    ...
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array("mailf" => __('Mail()','psythemes'), "smtp" => __('SMTP','psythemes')), //Required
...
array(
    ...
    "name" => __( "Extras", "psythemes" ), //Required
...
array(
    ...
    "id" => "psy-trailer-player-srvrn", //Required
...
array(
    ...
    "id" => "psy-trailer-player-srvrq", //Required
    "desc" => "Leave blank to use default.",
...
// pages settings 
	...
	"under_section" => "pages-config", 
    "type" => "pages", 
    "name" => __( "Request Page", "psythemes" ), 
    "display_checkbox_id" => "toggle_checkbox_id",
    "id" => "request_page", 
    "desc" => __( "Select relevant page.", "psythemes" )
),
...
//array(    "under_section" => "pages-config", //Required    "type" => "small_heading", //Required    "title" => __( "A-Z Library", "psythemes" ), //Required),
// array( 	// Field pages	"under_section" => "pages-config",     "type" => "pages",     "name" => __( "Library Page", "psythemes" ),     "display_checkbox_id" => "toggle_checkbox_id",    "id" => "librarive_page",     "desc" => __( "Select relevant page.", "psythemes" ),),
//array(    "under_section" => "pages-config", //Required    "type" => "number", //Required    "name" => __("Library: Post Per Page","psythemes"), //Required    "id" => "library_ppp", //Required    "desc" => __("Amount of post per page. Recommended: 40 ","psythemes"),	"default" => "40"),

array(

    "under_section" => "pages-config", //Required
    "type" => "small_heading", //Required
    "title" => __( "Archive Pages", "psythemes" ), //Required
),
...
array(
    ...
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array (__( "Rounded Corners (Posters)", "psythemes" ),__( "Border Effect (Posters)", "psythemes" )), //Required
	"default" => array("not", "not")
),	
...
array(
    ...
    "under_section" => "style-config",
    "type" => "small_heading",
    "title" => __("Logos & Images", "psythemes"),
),	
...
array(
	"under_section" => "watch-config",
	"type" => "small_heading",
	"title" => __( "Downloads Table", "psythemes" )
),

array(
    "under_section" => "watch-config", //Required
    "type" => "checkbox", //Required
    "name" => __( "Display On:", "psythemes" ), //Required
...
array(
	"under_section" => "watch-config",
	"type" => "small_heading",
	"title" => __( "Additional Notice", "psythemes" )
),
...
array(
    "under_section" => "watch-config", //Required
    "type" => "text", //Required
    "name" => __( "Note #1 - Message", "psythemes" ), //Required
...
array(
    "under_section" => "watch-config", //Required
    "type" => "text", //Required
    "name" => __( "Note #2 - Message", "psythemes" ), //Required
...
array(
    "under_section" => "watch-config", //Required
    "type" => "text", //Required
    "name" => __( "Note #3 - Message", "psythemes" ), //Required
...
array(
    ...
    "type" => "radio", //Required
    "name" => __( "Skipped Season", "psythemes" ), //Required
    "id" => "empty_seasons", //Required
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array("enable" => __('Display','psythemes'), "disable" => __('Hidden','psythemes')), //Required
    "desc" => __( "Choose an option", "psythemes" ),
    "default" => "enable"
),
...
array(
    ...
    "display_checkbox_id" => "toggle_checkbox_id",
    "options" => array("enable" => __('Enable','psythemes'), "disable" => __('Disable','psythemes')), //Required
    "desc" => __( "Display a splash image that user have to click to view the seasons & episodes", "psythemes" ),
    "default" => "disable"
),
...
array(
	...
	"type" => "small_heading",
	"title" => __( "Next Episode Notice", "psythemes" )
),

array(
    "under_section" => "tv-config",
    "type" => "checkbox",
    "name" => __("Toggle On/Off", "psythemes"),
    "id" => array("ep_sched"),
    "options" => array( __("Activate","psythemes"), ), 
    "default" => array("checked")
),
...
array(
    ...
    "title" => __( "Social Network", "psythemes" ), //Required
),
