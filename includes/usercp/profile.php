...
<img class="avatar" src="<?php echo get_template_directory_uri(); ?>/assets/css/img/default_avatar.jpg" title="<?php the_author_meta( 'first_name', $current_user->ID ); ?> <?php the_author_meta( 'last_name', $current_user->ID ); ?>" alt="<?php the_author_meta( 'first_name', $current_user->ID ); ?> <?php the_author_meta( 'last_name', $current_user->ID ); ?>">
</div>
<div class="uct-info">
<div class="block">
...
<div class="block">
<label><?php _e('Username:','psythemes'); ?></label><?php global $current_user; wp_get_current_user(); echo $current_user->user_login; ?></div>
<div class="block">
