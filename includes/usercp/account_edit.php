...
$error = array();
if ( isset( $_POST['update_user_nonce'] ) && wp_verify_nonce( $_POST['update_user_nonce'], 'update_user' ) ) {
...
<div class="col-sm-8">
<input type="text" readonly="" class="form-control" id="username" value="<?php global $current_user; wp_get_current_user(); echo $current_user->user_login; ?>">
</div>
</div>
<div class="form-group">
