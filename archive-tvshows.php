...
<span><?php _e('All TV Series', 'psythemes'); ?></span>
...
<li><a class="active" href="#"><i class="fa fa-clock-o mr5"></i><?php _e('Latest', 'psythemes'); ?></a></li>
<li><a href="#"><i class="fa fa-eye mr5"></i><?php _e('Most Viewed', 'psythemes'); ?></a></li>
<li><a class="" href="#"><i class="fa fa-heart mr5"></i><?php _e('Most Favorite', 'psythemes'); ?></a></li>
<li><a class="" href="#"><i class="fa fa-star mr5"></i><?php _e('Most Rating', 'psythemes'); ?></a></li>
<li><a class="" href="#"><i class="fa fa-fire mr5"></i><?php _e('Top IMDb', 'psythemes'); ?></a></li>
</ul>
</div>
<div class="col-sm-10">
