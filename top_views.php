...
$args = array();
$args['wp_query'] = array('post_type' => array('post','tvshows','episodes'),
'meta_key' => 'views', 
...
<span><?php _e('Most Viewed', 'psythemes'); ?></span>
...
<li><a class="active" href="<?php echo get_option('mviewed_archive'); ?>"><i class="fa fa-eye mr5"></i><?php _e('Most Viewed', 'psythemes'); ?></a></li>
