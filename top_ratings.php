<?php
/*
Template Name: Most Rating Page
*/
define('WPAS_DEBUG', false); get_header();  

$ppp = get_option('archive_posts');
$args = array();
$args['wp_query'] = array('post_type'=>array('post','tvshows','episodes',), 'meta_key' => 'ratings_average', 'orderby' => 'meta_value_num',
'posts_per_page' => $ppp,
'order' => 'DESC',
'orderby' => 'date');
...
<span><?php _e('Most Rating', 'psythemes'); ?></span>
...
<li><a class="active" href="<?php echo get_option('mrat_archive'); ?>"><i class="fa fa-star mr5"></i><?php _e('Most Rating', 'psythemes'); ?></a></li>
