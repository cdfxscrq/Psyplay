		<div class="home-main">
            ...
            <?php $homes_social = get_option('homes-social'); if($homes_social == "true") {?><div class="addthis_inline_share_toolbox mb10"></div>	<?php }?>
            <div id="hm-search">
                <div id="search-homepage" class="search-content">
				<form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
				<input class="form-control search-input" type="text" placeholder="<?php _e('Search..', 'psythemes'); ?>" name="s" id="s" value="<?php echo get_search_query(); ?>" data-swpconfig="home-search" <?php if(get_option('live-search') == "true") { echo 'data-swplive="true"';}?>>
